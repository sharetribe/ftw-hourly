...
const FEATURES_NAME = 'caddieTypes';
...
const EditListingFeaturesPanel = props => {
  ...
  const caddieTypes = publicData && publicData.caddieTypes;
  const initialValues = { caddieTypes };
  ...
  return (
    <div className={classes}>
      ...
      <EditListingFeaturesForm
        ...
        onSubmit={values => {
          const { caddieTypes = [] } = values;

          const updatedValues = {
            publicData: { caddieTypes },
          };
