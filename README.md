...
**time-based booking process**. This means that we are going to customize the template heavily later
on: changing translations, marketplace colors, logo, landing page and so on. Also, you should note
that currently, there isn't any way to add, remove or view availability exceptions.

Essentially this repository is a fork from the existing FTW repository (which is using nightly
