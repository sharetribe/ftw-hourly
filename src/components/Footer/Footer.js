              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?keywords=Health%20Practitioners',
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchHealth" />
                  </NamedLink>
                </li>
                ...
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?keywords=IT%20&%20Technology%20Gurus',
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchIT" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?keywords=Sports%20&%20Fitness%20Instructors',
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchSports" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchLegal" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?keywords=Educators%20&%20Teachers',
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchEducators" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?keywords=Fashionistas%20&%20Beauticians',
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchFashionistas" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?keywords=Home%20Improvement%20&%20Housekeeping',
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchHome" />
                  </NamedLink>
                </li>
              </ul>
            </div>
