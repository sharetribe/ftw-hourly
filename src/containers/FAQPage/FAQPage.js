...
const FAQPage = () => {
    const { siteSavanteInfor, siteSavanteWeb } = config;
            ...
            <LayoutSingleColumn>
                ...
                <LayoutWrapperMain className={css.mainWrapper}>
                    ...
                    <div>
                        ...
                        <p>Answer: Savante gives you the ability to book an appointment with professionals from anywhere in your city, state or country. Save on travel and get the help you need from the convenience of your home.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p>Answer: Choose a quiet room with good lighting. Make sure you have a good Internet connection and that your computer or personal device has audio/video functionality. Open your calendar/email app and click on the conference link to begin the video conference. Clients can use a mobile phone and choose not to share their video. Professionals, however, should use a stationary computer, laptop or tablet and always share their video.</p>
                    </div>
                    <div>
                        <h3>What is the service fee charged to professionals?</h3>
                        <p>Answer: Professionals are charged a 15% service fee for each transaction. The remaining amount is credited to your <ExternalLink href={siteSavanteWeb}>Savante.me</ExternalLink> account and can be withdrawn to your bank account at anytime. If you decide to offer a full refund to your client, a 15% service fee will apply to the transaction.</p>
                    </div>
                    <div>
                        <h3>What if I am not happy with my online appointment?</h3>
                        <p>Answer: Professionals always strive to provide their best service and appreciate good reviews. However, if you are not happy with the service, let the professional know where they can improve. The professional may decide to give you a refund of the session fee. Reviews are removed from the professional profile when a refund is made.</p>
                    </div>
                    <div>
                        <h3>What languages are offered?</h3>
                        <p>Answer: Currently Savante is available to English speakers. Other languages will be available as more professionals who can speak other languages sign up. Check the professional’s profile to see what languages they can speak.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p>Answer: Send an email to <ExternalLink href={siteSavanteInfor}>info@savante.me</ExternalLink> and we will reply as soon as possible.</p>
                    </div>
                </LayoutWrapperMain>
