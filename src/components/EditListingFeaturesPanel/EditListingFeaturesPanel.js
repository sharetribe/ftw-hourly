...
const EditListingFeaturesPanel = props => {
  ...
  const protein = publicData && publicData.protein;
  const initialValues = { foodType, protein };
  ...
  return (
    <div className={classes}>
      ...
      <EditListingFeaturesForm
        ...
        onSubmit={values => {
          const { foodType = [], protein = '' } = values;

          const updatedValues = {
            publicData: { foodType, protein },
          };
