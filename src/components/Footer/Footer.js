        ...
        <div className={css.content}>
              ...
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchTechnology" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                ...
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchFinance" />
                  </NamedLink>
                </li>
              </ul>
            </div>
              ...
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchEducation" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchFashion" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
            ...
            <div className={css.extraLinks}>
              ...
              <div className={css.legalMatters}>
                <ul className={css.tosAndPrivacy}>
                  ...
                  <li>
                    <NamedLink name="SupportPage" className={css.legalLink}>
          ...
          <div className={css.copyrightAndTermsMobile}>
            ...
            <div className={css.tosAndPrivacyMobile}>
              ...
              <NamedLink name="SupportPage" className={css.terms}>
                <FormattedMessage id="Footer.support" />
              </NamedLink>
            </div>
          </div>
