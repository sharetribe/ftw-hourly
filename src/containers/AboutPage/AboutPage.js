          ...
          <div className={css.contentWrapper}>
            ...
            <div className={css.contentMain}>
              ...
              <p>
                ...
                from KenkoFit, you can together create just the right class for you.
              </p>

              <h3 className={css.subtitle}>Are you a yoga trainer?</h3>

              <p>
                KenkoFit offers you a platform through which you can reach thousands of yoga
                practitioners. Offering private yoga classes through KenkoFit offers you a
                possibility to grow your customer base and earn some extra income on top of your
                regular classes.
              </p>

              <h3 id="contact" className={css.subtitle}>
                Create your own marketplace like KenkoFit
              </h3>
              <p>
                KenkoFit is brought to you by{' '}
                <ExternalLink href="http://sharetribe.com">KenkoFit</ExternalLink>. KenkoFit
